...
const albumsRelationships = {
    "artist": [{ "sourceField": ["artistId"], "destField": ["id"], "destSchema": "artists", "cardinality": "one" }],
    "favorites": [{ "sourceField": ["id"], "destField": ["albumId"], "destSchema": "favorites", "cardinality": "many" }]
} as const;
const artistsRelationships = {
    "albums": [{ "sourceField": ["id"], "destField": ["artistId"], "destSchema": "albums", "cardinality": "many" }]
} as const;
const favoritesRelationships = {
    "user": [{ "sourceField": ["userId"], "destField": ["id"], "destSchema": "users", "cardinality": "one" }],
    "album": [{ "sourceField": ["albumId"], "destField": ["id"], "destSchema": "albums", "cardinality": "one" }]
} as const;
const usersRelationships = {
    "favorites": [{ "sourceField": ["id"], "destField": ["userId"], "destSchema": "favorites", "cardinality": "many" }]
} as const;
/**
